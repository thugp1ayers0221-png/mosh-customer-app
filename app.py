...
ANNOUNCE_STYLES = {
    "スタイル1：詩的・上品": {
        "label": "スタイル1：詩的・上品",
        "description": "情景描写豊か・丁寧語・落ち着いたトーン",
        "prompt": """文体の特徴：
- 丁寧語（〜です・〜ます）を使う
- 香りや味の情景を詩的に描写する（例：「ひと口吸うと〜がふわっと広がり」「まるで〜のような」）
- 絵文字は控えめ（1〜2個）で上品に
- 落ち着いた、大人の雰囲気
- 構成：①オープン告知（丁寧に） ②フレーバーの香り・イメージを2文で描写 ③締めの一言""",
    },
    "スタイル2：元気・ハイテンション": {
        "label": "スタイル2：元気・ハイテンション",
        "description": "！！多め・若者言葉・フレンドリー",
        "prompt": """文体の特徴：
- 感嘆符（！！）を多用する
- 若者言葉OK（「まじで」「えぐい」「やばい」「絶対好きなやつ」）
- 絵文字を積極的に使う（3〜5個）
- テンション高め・フレンドリー・距離感近い
- 構成：①オープン！！ ②フレーバーの良さを勢いよく ③「来て！待ってます！」で締め""",
    },
    "スタイル3：シンプル・さらっと": {
        "label": "スタイル3：シンプル・さらっと",
        "description": "短文・テンポ良く・説明控えめ",
        "prompt": """文体の特徴：
- 短文でテンポよく（1文30字以内を目安）
- 説明は最小限。「香りいいです」「好きな人は絶対好き」程度で十分
- 絵文字1〜2個でシンプルに
- 過剰な描写なし。サラッと伝える
- 構成：①オープン（1文） ②フレーバー名と一言感想 ③「来てください」で締め（1文）""",
    },
    "スタイル4：ゆるり・ほっこり": {
        "label": "スタイル4：ゆるり・ほっこり",
        "description": "温かみ・ゆるい雰囲気・親しみやすい",
        "prompt": """文体の特徴：
- ゆるくて温かい雰囲気（「〜ですよ〜」「〜な感じです」「ぜひ〜してみてね」）
- 焦らせない・圧力をかけない・ほっこり系
- 絵文字は温かみのあるもの（🌿🌙🫧🍵など）
- 「気軽に来てください」「ゆっくりしていってね」系の締め
- 構成：①ゆるくオープン告知 ②フレーバーをほっこり描写 ③穏やかな来店促進""",
    },
    "スタイル5：プロモーション型": {
        "label": "スタイル5：プロモーション型",
        "description": "限定感・来店動機・お得感を強調",
        "prompt": """文体の特徴：
- 限定感・希少感を演出（「本日限り」「今夜だけ」「数量限定」など）
- 来店を迷わせない背中の一押し（「これは来るしかない」「損したくない人は来て」）
- フレーバーのメリット・体験価値を前面に
- 絵文字は🔥💥⚡などで興奮感を演出（2〜3個）
- 構成：①インパクトのある掴み ②フレーバーの魅力（体験価値） ③「今夜の選択肢はMOSHしかない」系の締め""",
    },
}
